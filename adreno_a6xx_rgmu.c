...
<<<<<<< TARGET BRANCH (24c9e4 Revert "msm: kgsl: Give hint to SMMU for skipping TLB ops du)
...
=======
>>>>>>> SOURCE BRANCH (709c72 kgsl: Prevent bind to VBO entries pending free in deferred w)
